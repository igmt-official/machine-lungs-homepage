    ...
    <main class="main">
              ...
              <a href="#" class="container">
                <div class="best-seller-container grid">
                  <div class="best-seller-img-box">
                    <img
                      src="img/Chroma-Astra.png"
                      alt="Chrome Astra E-Liquid"
                      loading="lazy"
                    />
                  </div>
            ...
            <li class="best-seller-list-item">
              <a href="#" class="container">
                <div class="best-seller-container grid">
                  <div class="best-seller-img-box">
                    <img
                      src="img/Magic-Cereal.png"
                      alt="Magic Cereal E-Liquid"
                    />
                  </div>
          ...
          <ul class="testimonial-list has-scrollbar">
            <li class="testimonial-list-item">
              <div class="container testimonial-container grid">
                ...
                <span class="testimonial-name"
                  >&mdash; Ivan Gregor Tabalno</span
                >
              </div>
            </li>
            ...
            <li class="testimonial-list-item">
              <div class="container testimonial-container grid">
                ...
                <span class="testimonial-name"
                  >&mdash; Richard Mark Manlapig</span
                >
              </div>
            </li>
          </ul>
      ...
      <article class="new" data-page="new">
        <section class="new-arrival">
          ...
          <ul class="new-list">
            <li
              class="new-list-item active"
              data-filter-item
              data-category="e-liquids"
            >
              <a href="#">
      ...
      <article class="shop" data-page="shop">
        <section class="products">
          ...
          <ul class="products-list">
            <li
              class="products-list-item active"
              data-filter-item
              data-category="e-liquids"
            >
              <a href="#">
